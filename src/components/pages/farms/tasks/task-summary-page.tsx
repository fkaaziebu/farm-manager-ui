...
type TaskSummaryCardProps = NonNullable<Task>;

const TaskSummaryCard: React.FC<{ tasks: TaskSummaryCardProps[] }> = ({
  tasks,
}) => {
  return (
      ...
      {tasks.map((task) => (
        <>
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-xl font-semibold capitalize">{task.type}</h2>
