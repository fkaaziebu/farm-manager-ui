            ...
            <div className="flex items-center">
              ...
              <div>
                <div className="flex flex-col sm:flex-row sm:items-center">
                  ...
                  <span
                    className={`mt-1 sm:mt-0 sm:ml-4 px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(house.status)}`}
                  >
                ...
                <p className="mt-1 text-xs sm:text-sm text-gray-500">
                  {house.type} • {house.size} • {house.occupancy} /{" "}
                      ...
                      <div>
                        ...
                        <div className="mt-2 w-full bg-gray-200 rounded-full h-2.5">
                          <div
                            ...
                            style={{
                              width: `${calculateOccupancy(house.occupancy, house.capacity)}%`,
                            }}
                          ></div>
                        </div>
                      </div>
              ...
              <div className="px-4 py-4 sm:px-6 sm:py-5">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-xs sm:text-sm text-yellow-700">
                        <span className="font-medium">Section D</span> has high
                        temperature (21.4°C) and ventilation issues
                      </p>
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 sm:p-4">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-xs sm:text-sm text-yellow-700">
                        <span className="font-medium">Section B</span> has high
                        humidity levels (72%)
                      </p>
                      <p className="text-xs text-yellow-500 mt-1">
                    ...
                    <dl className="grid grid-cols-2 gap-x-3 gap-y-3 sm:gap-x-4 sm:gap-y-4">
                      ...
                      <div className="sm:col-span-1">
                        ...
                        <dd className="mt-1 text-xs sm:text-sm text-gray-900 flex items-center">
                          {room.temperature}°C
                          <ThermometerSnowflake
                            className={`ml-1 h-3 w-3 sm:h-4 sm:w-4 ${getAlertColor(room.temperatureStatus)}`}
                          />
                        </dd>
                      </div>
                      <div className="sm:col-span-1">
                        ...
                        <dd className="mt-1 text-xs sm:text-sm text-gray-900 flex items-center">
                          {room.humidity}%
                          <Droplets
                            className={`ml-1 h-3 w-3 sm:h-4 sm:w-4 ${getAlertColor(room.humidityStatus)}`}
                          />
                        </dd>
                      </div>
                  ...
                  <div>
                    <dl className="grid grid-cols-2 gap-x-3 gap-y-4 sm:gap-x-4 sm:gap-y-6">
                      <div className="col-span-1">
                        ...
                        <dd className="mt-1 text-xs sm:text-sm text-gray-900 flex items-center">
                          <span
                            className={`mr-1 ${getAlertColor(house.maintenanceStatus)}`}
                          >
                            {house.maintenanceStatus.charAt(0).toUpperCase() +
                              house.maintenanceStatus.slice(1)}
                          </span>
                          <PenTool
                            className={`h-3 w-3 sm:h-4 sm:w-4 ${getAlertColor(house.maintenanceStatus)}`}
                          />
                        </dd>
                      </div>
                      <div className="col-span-1">
